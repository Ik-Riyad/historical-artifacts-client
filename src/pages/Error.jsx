...
import error404 from '../assets/resources/story/404.jpg';
        ...
        <div className='relative h-screen bg-no-repeat bg-center bg-cover bg-green-400 flex items-center justify-center' style={{ backgroundImage: `url(${error404})` }}>
            <div className='text-center w-6/12 text-white'>
                ...
                <div className='flex justify-center items-center gap-10 mt-5'>
                    <Link onClick={() => navigate(-1)} className='btn bg-[#3E1B0B] text-white'><IoIosArrowBack size={20} />Go Back</Link>
                    <Link to='/' className='btn bg-[#3E1B0B] text-white'><FaHouse size={15} />Go Home</Link>
                </div>
            </div>
