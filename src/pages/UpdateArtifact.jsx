...
const UpdateArtifact = () => {
    ...
    const handleUpdate = e => {
        ...
        axios.put(`https://historical-artifact-server.vercel.app/artifacts/${_id}`, artifacts)
            .then(res => {
                const data = res.data;
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-amber-700 mb-6">
                        Update artifact details to keep our historical collection accurate and enriched.
                    </p>
                ...
                <form onSubmit={handleUpdate} className="space-y-8">
                    ...
                    <div className="text-center pt-8">
                        <button
                             className="px-12 py-4 bg-gradient-to-r from-amber-900 to-orange-900 text-white text-lg font-bold rounded-xl shadow-2xl hover:from-amber-800 hover:to-orange-800 transform hover:scale-105 transition-all duration-300 hover:shadow-3xl cursor-pointer"
                        >
                            🏺 Add Artifact
                        </button>
                    </div>
